...
public class BouncingBall implements Runnable {
    ...
    // геттер радиуса( метод предоставляет значение приватного поля класса BouncingBall)
    public int getRadius(){
        return radius;
    }
    // геттер скорости( метод предоставляет значение приватного поля класса BouncingBall)
    public int getSpeed(){
        return speed;
    }
    // геттер скорости по оси Х( метод предоставляет значение приватного поля класса BouncingBall)
    public double getSpeedX(){ return speedX; }
    // геттер скорости по оси У( метод предоставляет значение приватного поля класса BouncingBall)
